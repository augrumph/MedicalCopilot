...
import { Search, Users, UserPlus, Eye, TrendingUp, ChevronDown, X, FileText, Pill, Calendar, Activity, AlertCircle, ArrowRight, Plus, Home} from'lucide-react';
...
'from-[#00E676] to-[#00C853]',
 ...
 className="rounded-xl bg-gray-100 p-4 md:p-5 shadow-lg space-y-3"
 >
 ...
 className="bg-white text-[#450693] shadow-lg px-4 py-2 h-auto text-sm font-semibold"
 >
 ...
 >
 <Card className="relative overflow-hidden border-0 shadow-xl transition-all duration-300 group">
 <div className={`absolute inset-0 bg-gradient-to-br ${stat.gradient} opacity-5 group-transition-opacity`} />
 ...
 >
 <Card className={cn(
"relative overflow-hidden border-0 shadow-xl transition-all duration-300 group",
...
'bg-gray-50 text-gray-700 border-gray-200'
 ...
 <div className="flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-br from-gray-50 to-white rounded-xl border-2 border-dashed border-gray-200">
 <div className="w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mb-4">
 <FileText className="w-10 h-10 text-purple-600" />
 </div>
 <h3 className="text-lg font-bold text-gray-900 mb-2">Nenhuma Receita Encontrada</h3>
 <p className="text-sm text-gray-500 text-center max-w-md mb-6">
 Este paciente ainda não possui receitas médicas cadastradas. Inicie uma consulta para criar a primeira prescrição.
 </p>
 <Button
 onClick={() => navigate('/consultation')}
 className="bg-[#8C00FF] hover:bg-[#7a00df]"
 >
 ...
 <h3 className="text-lg font-bold text-gray-900 mb-2">Nenhum Documento Anexado</h3>
 <p className="text-sm text-gray-500 text-center max-w-md mb-6">
 Ainda não há documentos anexados para este paciente. Adicione exames, laudos ou outros documentos relevantes.
 </p>
 <Button
 variant="outline"
 ...
 <Card className="border border-gray-300 shadow-sm transition-shadow">
 <CardContent className="p-4">
 ...
 className="bg-gradient-to-r from-[#8C00FF] to-[#450693] text-white"
 >
