...
"[IA gerará] Pergunta sobre evolução do sintoma mais importante"
 ...
 {kpis.map((kpi, idx) => (
 <Card key={idx} className="border-0 shadow-md transition-shadow">
 ...
 */}
 ...
 <div key={idx} className="bg-white rounded-lg p-4 border border-amber-200 shadow-sm transition-shadow">
