    ...
    return (
        ...
        >
                                ...
                                return (
                                    <SidebarMenuItem key={item.title}>
                                        <Link
                                            ...
                                            title={item.title}
                                            className={cn(
                                                "flex items-center gap-3 px-3 py-2.5 rounded-lg group/item",
                                        ...
                                        >
                                            <item.icon className={cn(
                                                ...
                                                active ? "text-[#8C00FF]" : "text-gray-500"
                                            )}
                                                aria-hidden="true" />
                                            <span className={cn(
            ...
            <SidebarFooter className="border-t border-white/20 p-3 group-data-[collapsible=icon]:p-2">
                <SidebarMenu>
                    <SidebarMenuItem>
                        <div className="flex items-center gap-3 rounded-lg p-2 group/footer group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-2">
                            <Avatar
                            ...
                            <Button
                                ...
                                className="h-8 w-8 group-data-[collapsible=icon]:hidden flex-shrink-0"
                                title="Sair"
                            >
