            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
              ...
              {notifications.some(n => !n.read) && (
                <Button
                  ...
                  className="text-[#8C00FF] hover:text-[#8C00FF] hover:bg-[#8C00FF]/10"
                >
                ...
                {filteredNotifications.length === 0 ? (
                  ...
                  filteredNotifications.map((notification) => (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-white bg-opacity-90 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-end p-4 gap-2">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => markAsRead(notification.id)}
