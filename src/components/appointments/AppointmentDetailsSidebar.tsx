        ...
        <div className="pt-4 border-t border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button
              ...
              className={appointment.status === 'confirmed' ? 'bg-[#8C00FF] hover:bg-[#7a00e6]' : ''}
            ...
            <Button
              ...
              className={appointment.status === 'completed' ? 'bg-green-600 hover:bg-green-700' : ''}
            ...
            <Button
              ...
              className={appointment.status === 'cancelled' ? 'bg-red-600 hover:bg-red-700' : ''}
            ...
            <Button
              ...
              className={appointment.status === 'no-show' ? 'bg-gray-600 hover:bg-gray-700' : ''}
