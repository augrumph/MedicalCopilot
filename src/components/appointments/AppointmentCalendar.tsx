      ...
      <div className="px-6 mb-4 flex items-center justify-between">
        <div className="flex gap-2">
          <Button
            ...
            className={viewMode === 'day' ? 'bg-[#8C00FF] hover:bg-[#7a00e6]' : ''}
          >
            Dia
          </Button>
          <Button
            ...
            className={viewMode === 'week' ? 'bg-[#8C00FF] hover:bg-[#7a00e6]' : ''}
          >
            Semana
          </Button>
        </div>
                    ...
                    {slotAppointments.length > 0 ? (
                      <div className="space-y-2">
                        {slotAppointments.map((apt) => (
                          <div
                            key={apt.id}
                            className="p-3 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border-l-4 border-[#8C00FF] cursor-pointer hover:shadow-md transition-all"
                    ...
                    return (
                      ...
                      >
                        {slotAppointments.map((apt) => (
                          <div
                            key={apt.id}
                            className="p-2 mb-1 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border-l-4 border-[#8C00FF] cursor-pointer hover:shadow-md transition-all text-xs"
                            onClick={() => onAppointmentClick?.(apt)}
                          >
