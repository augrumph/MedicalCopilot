                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        {!microsoftCalendar.connected ? (
                                            <Card
                                                className="border-2 border-gray-200 hover:border-sky-400 hover:shadow-lg transition-all cursor-pointer group"
                                                onClick={() => {
                                                    if (isMicrosoftConfigured) {
                                            ...
                                            >
                                                <CardContent className="p-5">
                                                    <div className="flex flex-col items-center text-center gap-3">
                                                        ...
                                                        <div>
                                                            <h3 className="text-base font-bold text-gray-900 group-hover:text-sky-600 transition-colors mb-1">
                                                                Outlook / Office 365
                                                            </h3>
                                                            <p className="text-xs text-gray-600">
                                                        ...
                                                        <ChevronRight className="h-5 w-5 text-gray-400 group-hover:text-sky-600 group-hover:translate-x-1 transition-all" />
                                                    </div>
                                                </CardContent>
                                            </Card>
                                        ) : (
                                        ...
                                        {/* Apple Calendar Card */}
                                        <Card
                                            className="border-2 border-gray-200 hover:border-gray-400 hover:shadow-lg transition-all cursor-pointer group"
                                        ...
                                        >
                                            <CardContent className="p-5">
                                                <div className="flex flex-col items-center text-center gap-3">
                                                    ...
                                                    <ChevronRight className="h-5 w-5 text-gray-400 group-hover:text-gray-700 group-hover:translate-x-1 transition-all" />
                                                </div>
                                            </CardContent>
                                        </Card>
                                        ...
                                        {/* Other Systems Card */}
                                        <Card
                                            className="border-2 border-gray-200 hover:border-purple-400 hover:shadow-lg transition-all cursor-pointer group"
                                        ...
                                        >
                                            <CardContent className="p-5">
                                                <div className="flex flex-col items-center text-center gap-3">
                                                    ...
                                                    <div>
                                                        <h3 className="text-base font-bold text-gray-900 group-hover:text-purple-600 transition-colors mb-1">
                                                            Outros Sistemas
                                                        </h3>
                                                        <p className="text-xs text-gray-600">
